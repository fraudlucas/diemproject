<?php	
	...
	$ourteamManagementPhotosView = new ManagementPhotosView();
	$ourteamManagementContentView = new ManagementContentView();
	$ourteamPhotosList = $ourteamManagementPhotosView->searchPhotos('pageId','6','2');
				...
				<div class="main-box no-header clearfix">
					<div class="main-box-body clearfix">
						<div class="table-responsive">
							<form  role="form" action="../../src/handlers/managementPhotosHandler.php?a=updatePhoto&b=6" method="post" enctype="multipart/form-data">
			...
			<div class="container" style="width:100%">
			  <div class="hero-unit" >
					...
					* https://github.com/mindmup/bootstrap-wysiwyg/blob/master/README.md#customising-
					-->
					<div id="alerts"></div>
					<form action="../../src/handlers/managementContentHandler.php?a=updateContent&b=6" method="post">
						<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
						  ...
						  <input type="hidden" name="content" id="ourteam_dash_new_shout_textarea_hidden" />
							<script type="text/javascript">
							setInterval(function () {
							  document.getElementById("ourteam_dash_new_shout_textarea_hidden").value = document.getElementById("ourteamflag").nextElementSibling.innerHTML;
							}, 5);
							</script>
					...
					<div id="ourteamflag"></div>
					<div id="editor" contenteditable="true"><?php echo $ourteamManagementContent->getContent();?></div>
				</div>
		  </div>
