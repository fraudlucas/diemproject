<?php
	...
	$pageToReturn = 'staffLooks'; // Will be used by the adminMessages
				...
				<nav class="navbar-default"  role="navigation">
					<ul class="nav nav-pills nav-stacked">
					  <li>
						...
						<li role="presentation" class="active"><a href="../pages/staffLooks.php">Create Looks</a></li>
																...
																<div class="col-md-5">
																	<div class="col-md-12">
																		...
																		<center>
																		   ...
																		   <form method="POST" action="../../src/handlers/looksHandler.php?a=clothesAdd&p=<?php echo $pageToReturn; ?>">
